...
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_dnabert2-curriculum-512-phylum.csv dnabert2 /app/dnabert_2_curriculum_patience_5_batch_size_60_max_length_512/curriculum_stage_phylum/merged_model data/genomes/GRCh38.primary_assembly.genome.fa --embedding_idx 256
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_dnabert2-curriculum-512-class.csv dnabert2 /app/dnabert_2_curriculum_patience_5_batch_size_60_max_length_512/curriculum_stage_class/merged_model data/genomes/GRCh38.primary_assembly.genome.fa --embedding_idx 256
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_dnabert2-curriculum-512-order.csv dnabert2 /app/dnabert_2_curriculum_patience_5_batch_size_60_max_length_512/curriculum_stage_order/merged_model data/genomes/GRCh38.primary_assembly.genome.fa --embedding_idx 256
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_dnabert2-curriculum-512-family.csv dnabert2 /app/dnabert_2_curriculum_patience_5_batch_size_60_max_length_512/curriculum_stage_family/merged_model data/genomes/GRCh38.primary_assembly.genome.fa --embedding_idx 256
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_dnabert2-curriculum-512-genus.csv dnabert2 /app/dnabert_2_curriculum_patience_5_batch_size_60_max_length_512/curriculum_stage_genus/merged_model data/genomes/GRCh38.primary_assembly.genome.fa --embedding_idx 256
python3 scripts/predict_variant_effects.py $VARIANT_FILE $OUT_DIR/${OUT_PREFIX}_hyenadna-no-overlap.csv hyenadna fine_tuned_models/hyenadna_no_overlap data/genomes/GRCh38.primary_assembly.genome.fa --extra_context 512 --embedding_idx 511
